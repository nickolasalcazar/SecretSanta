...
add_player_btn.addEventListener('click', function(event) {
    ...
    // Bug exists here.
    // regex works correctly for createGame()
    // but not for updateGame()
    // This is due to the the two views having different form IDs generated by Django

    //console.log('newPlayerForm.innerHTML before: ', newPlayerForm.innerHTML)
    ...
    //newPlayerForm.innerHTML = newPlayerForm.innerHTML.replace(formRegex, `form-${formCount}-`);
    //console.log(' newPlayerForm.innerHTML after: ', newPlayerForm.innerHTML)
